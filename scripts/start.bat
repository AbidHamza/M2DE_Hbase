...
!COMPOSE_CMD! logs hive-metastore hive 2>&1 | findstr /I /C:"Cannot find hadoop" /C:"HADOOP_HOME" /C:"HADOOP_CONF_DIR" /C:"Hadoop binaries" /C:"hadoop.*command" /C:"ERROR" /C:"XBM0J" /C:"metastore_db" /C:"Database.*not found" /C:"Device or resource busy" /C:"Unable to instantiate" /C:"SessionHiveMetaStoreClient" >nul 2>&1
if not errorlevel 1 (
    set HIVE_ERRORS=1
